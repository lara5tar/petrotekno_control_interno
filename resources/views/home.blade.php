...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-200">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <!-- Vehículos -->
            <a href="{{ route('vehiculos.index') }}" class="group flex flex-col items-center p-4 bg-gray-50 hover:bg-petroyellow hover:bg-opacity-20 rounded-lg transition duration-200 border border-gray-100">
                <div class="bg-gray-200 group-hover:bg-petroyellow group-hover:bg-opacity-30 p-3 rounded-full mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 group-hover:text-petrodark" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z"/>
                    </svg>
                </div>
            ...
            <!-- Kilometrajes -->
            <a href="{{ route('kilometrajes.index') }}" class="group flex flex-col items-center p-4 bg-gray-50 hover:bg-petroyellow hover:bg-opacity-20 rounded-lg transition duration-200 border border-gray-100">
                <div class="bg-gray-200 group-hover:bg-petroyellow group-hover:bg-opacity-30 p-3 rounded-full mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 group-hover:text-petrodark" viewBox="0 0 24 24" fill="currentColor">
            ...
            <!-- Personal -->
            <a href="{{ route('personal.index') }}" class="group flex flex-col items-center p-4 bg-gray-50 hover:bg-petroyellow hover:bg-opacity-20 rounded-lg transition duration-200 border border-gray-100">
                <div class="bg-gray-200 group-hover:bg-petroyellow group-hover:bg-opacity-30 p-3 rounded-full mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 group-hover:text-petrodark" viewBox="0 0 20 20" fill="currentColor">
            ...
            <!-- Obras -->
            <a href="{{ route('obras.index') }}" class="group flex flex-col items-center p-4 bg-gray-50 hover:bg-petroyellow hover:bg-opacity-20 rounded-lg transition duration-200 border border-gray-100">
                <div class="bg-gray-200 group-hover:bg-petroyellow group-hover:bg-opacity-30 p-3 rounded-full mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 group-hover:text-petrodark" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM7 5h10v2H7V5zm0 4h10v2H7V9zm0 4h10v2H7v-2z" />
                    </svg>
            ...
            <!-- Mantenimientos -->
            <a href="{{ route('mantenimientos.index') }}" class="group flex flex-col items-center p-4 bg-gray-50 hover:bg-petroyellow hover:bg-opacity-20 rounded-lg transition duration-200 border border-gray-100">
                <div class="bg-gray-200 group-hover:bg-petroyellow group-hover:bg-opacity-30 p-3 rounded-full mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 group-hover:text-petrodark" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
                    </svg>
                </div>
                <span class="text-sm font-medium text-gray-700 group-hover:text-gray-800 text-center">Mantenimientos</span>
            </a>

            <!-- Alertas -->
            <a href="{{ route('kilometrajes.alertas') }}" class="group flex flex-col items-center p-4 bg-gray-50 hover:bg-petroyellow hover:bg-opacity-20 rounded-lg transition duration-200 border border-gray-100">
                <div class="bg-gray-200 group-hover:bg-petroyellow group-hover:bg-opacity-30 p-3 rounded-full mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 group-hover:text-petrodark" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                    </svg>
    ...
    <!-- Alertas de Mantenimiento Críticas -->
    @if($alertasMantenimiento->count() > 0)
    <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-red-800">Vehículos próximos a mantenimiento</h3>
                <div class="mt-2 text-sm text-red-700">
                    <ul class="list-disc pl-5 space-y-1">
                        @foreach($alertasMantenimiento as $alerta)
                        <li>
                            <strong>{{ $alerta['vehiculo'] }}</strong> - 
                            {{ number_format($alerta['km_actual']) }} km actual, 
                            próximo mantenimiento en {{ number_format($alerta['km_proximo_mantenimiento']) }} km 
                            ({{ number_format($alerta['km_restantes']) }} km restantes)
                            @if($alerta['tipo_alerta'] === 'critica')
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 ml-2">Crítico</span>
                            @else
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 ml-2">Advertencia</span>
                            @endif
                        </li>
                        @endforeach
                    </ul>
