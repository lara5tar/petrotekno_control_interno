        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Editar Obra: {{ $obra->nombre_obra }}</h4>
                    <div>
                        <a href="{{ route('obras.show', $obra) }}" class="btn btn-info">
                    ...
                    <form action="{{ route('obras.update', $obra) }}" method="POST">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('estatus') is-invalid @enderror" 
                                    ...
                                    @foreach($estatusOptions as $valor => $nombre)
                                        <option value="{{ $valor }}" 
                                                {{ old('estatus', $obra->estatus) == $valor ? 'selected' : '' }}>
                                            {{ $nombre }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('obras.show', $obra) }}" class="btn btn-secondary ms-2">
                                    Cancelar
                                </a>
                            </div>
                        </div>
