...
@section('title', 'Nuevo Puesto de Personal')

@section('header', 'Crear Nuevo Puesto')
...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Nuevo Puesto de Personal</h2>
    ...
    @if ($errors->any())
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6" role="alert">
            <div class="font-bold">Error al crear el puesto:</div>
