    ...
    <div class="bg-white rounded-lg shadow-lg">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Editar Rol: {{ $role->nombre_rol }}</h1>
                    <p class="text-sm text-gray-600 mt-1">Modifica la información y permisos de este rol</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           class="w-full border @error('nombre_rol') border-red-500 @else border-gray-300 @enderror rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <textarea id="descripcion" 
                                              name="descripcion" 
                                              rows="4"
                                              class="w-full border @error('descripcion') border-red-500 @else border-gray-300 @enderror rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
