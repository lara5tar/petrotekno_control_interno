...
<div class="bg-white min-h-screen">
    ...
    <div class="bg-petrodark text-white p-4 flex justify-between items-center">
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-lg font-semibold">Control de Personal de Petrotekno</h1>
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-petroyellow p-4">
            ...
            <nav class="space-y-2">
                <a href="{{ route('personal.index') }}" class="flex items-center space-x-3 text-petrodark hover:bg-yellow-400 p-3 rounded">
