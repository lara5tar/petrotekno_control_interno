                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form method="POST" action="{{ route('tipos-activos.toggle-kilometraje', $tipoActivo) }}" class="inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit" 
                                                    class="text-xs px-2 py-1 rounded transition duration-200 {{ $tipoActivo->tiene_kilometraje ? 'bg-red-100 text-red-700 hover:bg-red-200' : 'bg-green-100 text-green-700 hover:bg-green-200' }}"
                                                    title="{{ $tipoActivo->tiene_kilometraje ? 'Desactivar kilometraje' : 'Activar kilometraje' }}">
                                                {{ $tipoActivo->tiene_kilometraje ? 'Desactivar' : 'Activar' }}
                                            </button>
                                        </form>
                                        @endhasPermission
                                    </div>
