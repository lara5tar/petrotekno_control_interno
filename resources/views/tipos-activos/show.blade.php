        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Maneja Placas</dt>
                        <dd class="mt-1">
                    ...
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Maneja Número de Serie</dt>
                        <dd class="mt-1">
