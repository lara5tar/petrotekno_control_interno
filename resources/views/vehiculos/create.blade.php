...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Crear Nuevo Vehículo</h2>
                    ...
                    <div>
                        ...
                        <select id="estatus_id" 
                            ...
                            @foreach($estatusOptions as $estatus)
                                <option value="{{ $estatus->id }}" {{ old('estatus_id') == $estatus->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" 
                                   ...
                                   value="{{ old('kilometraje_actual', 0) }}" 
                                   min="0"
