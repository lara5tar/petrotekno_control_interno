                        ...
                        <div class="form-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       class="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-petroyellow focus:border-petroyellow @error('valor_comercial') border-red-500 @enderror">
                            </div>
                            @error('valor_comercial') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                            <p class="mt-1 text-xs text-gray-500">Valor comercial del vehículo o maquinaria</p>
                        </div>
                    </div>
