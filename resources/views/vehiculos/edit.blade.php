            ...
            <div class="space-y-8">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <!-- Valor Comercial -->
                        <div>
                            <label for="valor_comercial" class="block text-sm font-medium text-gray-700 mb-1">
                                Valor Comercial
                            </label>
                            <input type="number" 
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Valor comercial del vehículo o maquinaria en pesos mexicanos</p>
                        </div>
