        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="bg-white border border-gray-300 rounded-lg">
                <div class="bg-gray-50 px-3 py-2 border-b border-gray-300">
                    <h3 class="font-medium text-gray-800 text-sm">Datos Generales</h3>
                </div>
                <div class="p-3">
                    <div class="grid grid-cols-2 gap-2 text-xs">
                        <div class="p-2 bg-gray-50 rounded">
                            <div class="text-gray-600">Marca</div>
                            <div class="font-semibold">{{ $vehiculo->marca ?? 'Nissan' }}</div>
                        </div>
                        <div class="p-2 bg-gray-50 rounded">
                            <div class="text-gray-600">Modelo</div>
                            <div class="font-semibold">{{ $vehiculo->modelo ?? 'NP300' }}</div>
                        </div>
                        <div class="p-2 bg-gray-50 rounded">
                            <div class="text-gray-600">Año</div>
                            <div class="font-semibold">{{ $vehiculo->año ?? '2023' }}</div>
                        </div>
                        <div class="p-2 bg-gray-50 rounded">
                            <div class="text-gray-600">Color</div>
                            <div class="font-semibold">{{ $vehiculo->color ?? 'Blanco' }}</div>
                        </div>
                        <div class="p-2 bg-gray-50 rounded">
                            <div class="text-gray-600">Placas</div>
                            <div class="font-semibold">{{ $vehiculo->placas ?? 'NL-ABC-1234' }}</div>
                        </div>
                        <div class="p-2 bg-gray-50 rounded">
                            <div class="text-gray-600">Serie</div>
                            <div class="font-semibold">{{ $vehiculo->serie ?? 'NS123456789' }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-300 rounded-lg">
                <div class="bg-gray-50 px-3 py-2 border-b border-gray-300">
                    <h3 class="font-medium text-gray-800 text-sm">Fotografía del Vehículo</h3>
                </div>
                <div class="p-3">
                    <div class="relative">
                        <div class="aspect-video bg-gray-100 rounded overflow-hidden mb-2">
                        ...
                        <div class="flex justify-center space-x-2">
                            <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-xs">Actualizar</button>
                            <button class="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 rounded text-xs">Descargar</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col gap-4">
                ...
                <div class="bg-white border border-gray-300 rounded-lg">
                    ...
                    <div class="p-3">
                        <div class="bg-orange-500 text-white p-3 rounded text-center">
                            ...
                            <button class="mt-2 text-xs bg-white bg-opacity-20 px-2 py-1 rounded hover:bg-opacity-30">
                                Cambiar Obra
                            </button>
                        </div>
                    </div>
            ...
            <div class="bg-white border border-gray-300 rounded-lg flex-1 flex flex-col" x-data="{ activeTab: 'operacion' }">
                ...
                <div class="flex-1 overflow-hidden">
                    ...
                    <div x-show="activeTab === 'operacion'" class="p-3 h-full overflow-y-auto">
                        <div class="space-y-3">
                            <!-- Sección: Obra Actual -->
                            <div class="bg-blue-50 border border-blue-200 rounded p-2">
                                <h5 class="text-xs font-semibold text-blue-900 mb-2 flex items-center">
                                ...
                                <div class="space-y-2">
                                    <div class="bg-white p-2 rounded border text-xs">
                                        <div class="font-medium text-gray-600">Nombre de Obra</div>
                                        <div class="font-semibold text-gray-900">Libramiento Monterrey</div>
                                    </div>
                                    
                                    <div class="bg-white p-2 rounded border text-xs">
                                        <div class="font-medium text-gray-600">Ubicación</div>
                                        <div class="font-semibold text-gray-900">Monterrey, N.L.</div>
                                    </div>
                                    
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="bg-white p-2 rounded border text-xs">
                                            <div class="font-medium text-gray-600">Inicio</div>
                                            <div class="font-semibold text-gray-900">1/02/2025</div>
                                        </div>
                                        <div class="bg-white p-2 rounded border text-xs">
                                            <div class="font-medium text-gray-600">Km. Final</div>
                            ...
                            <div class="bg-green-50 border border-green-200 rounded p-2">
                                <h5 class="text-xs font-semibold text-green-900 mb-2 flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="space-y-2">
                                    <div class="bg-white p-2 rounded border text-xs">
                                        <div class="flex justify-between items-center mb-1">
                                            <div class="font-medium text-gray-600">Operador Actual</div>
                                            <button class="text-xs bg-green-500 hover:bg-green-600 text-white px-1 py-0.5 rounded">Cambiar</button>
                                        </div>
                                        <div class="font-semibold text-gray-900">Marco Alfredo</div>
                                    </div>
                                    
                                    <div class="bg-white p-2 rounded border text-xs">
                                        <div class="font-medium text-gray-600">Supervisor</div>
                                        <div class="font-semibold text-gray-900">Tonko de las Mercedes</div>
                                    </div>
                                    
                                    <div class="bg-white p-2 rounded border text-xs">
                                        <div class="font-medium text-gray-600">Responsable</div>
                                        <div class="font-semibold text-gray-900">Delgado Reyes</div>
                                    </div>
                                    
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="bg-white p-2 rounded border text-xs">
                                            <div class="font-medium text-gray-600">Cert. Electrónica</div>
                                            <div class="font-semibold text-gray-900">5588</div>
                                        </div>
                                        <div class="bg-white p-2 rounded border text-xs">
                                            <div class="font-medium text-gray-600">Licencia</div>
                                            <div class="font-semibold text-gray-900 break-all">DERM620912384</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div x-show="activeTab === 'documentos'" class="p-3 h-full overflow-y-auto">
                        <div class="space-y-3">
                            ...
                            <div class="border border-gray-200 rounded divide-y divide-gray-200">
                                <div class="p-2 hover:bg-gray-50">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-gray-900">Tarjeta de Circulación</p>
                                            <p class="text-xs text-gray-500">Vigente hasta: 15/08/2025</p>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="px-1.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">✓</span>
                                            <button class="text-blue-600 hover:text-blue-900" onclick="viewDocument('tarjeta_circulacion.pdf')">
                                ...
                                <div class="p-2 hover:bg-gray-50">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-gray-900">Póliza de Seguro</p>
                                            <p class="text-xs text-gray-500">Vigente hasta: 20/12/2025</p>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="px-1.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">✓</span>
                                            <button class="text-blue-600 hover:text-blue-900" onclick="viewDocument('poliza_seguro.pdf')">
                                                <svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                </svg>
                                ...
                                <div class="p-2 hover:bg-gray-50">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-gray-900">Verificación Vehicular</p>
                                            <p class="text-xs text-gray-500">Vence: 30/08/2025</p>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="px-1.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">⚠</span>
                                            <button class="text-blue-600 hover:text-blue-900" onclick="viewDocument('verificacion_vehicular.pdf')">
                                                <svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                </svg>
                            ...
                            <button class="w-full bg-gray-600 hover:bg-gray-700 text-white py-1.5 px-3 rounded text-xs">
                                + Agregar Documento
                            </button>
                        </div>
                    </div>
